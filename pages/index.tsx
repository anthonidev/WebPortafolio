...
const index = () => {
  ...
  return (
    <div className='flex flex-col px-6 pt-1 flex-grow'>
      ...
      <div className='p-4 mt-5 bg-gray-400 flex-grow dark:bg-dark-200 ' style={{ marginLeft: '-1.5rem', marginRight: '-1.5rem' }}>
        <h6 className='my-3 font-bolt text-xl tracking-wide'>What i Offer</h6>
        <div className='grid lg:grid-cols-2 gap-6'>
          {
            services.map(service => (
              <div className='lg:col-span-1 rounded-lg bg-gray-100 '>
