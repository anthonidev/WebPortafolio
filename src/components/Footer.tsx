            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="p-3 bg-foreground/5 rounded-lg hover:bg-foreground/10 transition-colors"
        ...
        <div className="pt-8 border-t border-foreground/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-foreground/60">
              © {currentYear} Anthoni Portocarrero. Todos los derechos reservados.
            </p>
            <p className="text-sm text-foreground/60">
              Hecho con{' '}
              <span className="text-red-500">♥</span> usando Next.js y Tailwind CSS
            </p>
          </div>
        </div>
      </div>
