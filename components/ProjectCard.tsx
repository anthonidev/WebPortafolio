  ...
  project: {
    ...
    return (
      <div>
        ...
        {
          showDetail && (
            <div className="absolute top-0 left-0 grid z-10 p-2 dark:bg-dark-100 md:grid-cols-2 h-auto w-full gap-x-12 text-black bg-gray-100 dark:text-white">
              <div>
              ...
              <div>
                ...
                <button
                  ...
                  onClick={() => setShowDetail(false)}><MdClose size={30} /></button>
              </div>
            </div>
          )
